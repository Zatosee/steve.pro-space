...
const HoldToConfirmButton = ({
  ...
  return (
    <motion.button
      ...
      className="relative inline-flex items-center justify-center px-6 py-3 rounded-full bg-red-500 text-white font-semibold overflow-hidden"
    >
      {children}
      <motion.div
        ...
        return (
          <>
            ...
            STEVE.SPACE
                 ...
                 <Link
                  to="/"
                  className="absolute top-4 left-6 text-white text-sm md:text-base font-bold tracking-widest uppercase font-[Inter] group"
                >
                  <span className="relative">
                    STEVE.SPACE
                    <motion.span
                      layoutId="underline"
                      className="absolute bottom-0 left-0 w-0 h-[2px] bg-pink-500 group-hover:w-full transition-all duration-500"
                    />
                  </span>
                </Link>
            ...
            >
              ...
              <HoldToConfirmButton onConfirm={() => fullpageApi.moveSectionDown()}>
                    Voir mon travail
                </HoldToConfirmButton>
          ...
          <div className="section bg-gradient-to-r from-[#1e6f36] to-[#4dc26b] relative flex items-center justify-center text-white">
          <Link
            to="/"
            className="absolute top-4 left-6 text-white text-sm md:text-base font-bold tracking-widest uppercase font-[Inter]"
          >
            STEVE.SPACE
          </Link>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <ProjectCard
                    ...
                    description="Site vitrine moderne pour une vendeuse de produits sur instagram."
